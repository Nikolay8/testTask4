...
/** Screen to show successful addition of new user */
@Composable
fun SignUpSuccessScreen(
    onNextButtonClicked: () -> Unit, viewModel: TestTaskViewModel
) {
...
@Composable
fun SignUpSuccessScreenPrev() {
    TestTask4Theme {
        SignUpSuccessScreen(
            onNextButtonClicked = {}, viewModel = TestTaskViewModel(application = Application())
        )
    }
}
